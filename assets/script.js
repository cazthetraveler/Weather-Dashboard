...
$(document).on("click", ".search-history-button", function() {
    var savedCityName = $(this).attr("data-city");
    var requestURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + savedCityName + "&appid=282d710887f9d5d5a0f6834957e54e94";
